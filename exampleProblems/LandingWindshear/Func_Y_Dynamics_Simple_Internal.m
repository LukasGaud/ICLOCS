...
cada1f1dY = X.dY;
cada1f1 = X.f(:);
cada1td1 = sparse(Gator1Data.Index2,Gator1Data.Index3,cada1f1dY,902,902);
...
cada1f1dY = U.dY;
cada1f1 = U.f(:);
cada1td1 = sparse(Gator1Data.Index5,Gator1Data.Index6,cada1f1dY,1353,1353);
...
cada1f1 = dynF_org.f(:);
cada1td1 = sparse(Gator1Data.Index53,Gator1Data.Index54,cada1f1dY,902,1807);
...
cada1td1 = sparse(Gator1Data.Index58,Gator1Data.Index59,X_vect.dY,902,902);
