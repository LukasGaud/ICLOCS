...
%     index2 = 1;
    ...
    hold on
    % ka vs RRH
    plot((solution{i}.X(:,1) + mean(problem{i}.data.auxData.HF.RRHSetup))*1000, solution{i}.U(:,1), '.', 'MarkerSize', 5, 'Color', colors(index4))
    plot((solution{i}.X(:,1) + mean(problem{i}.data.auxData.HF.RRHSetup))*1000, solution{i}.U(:,1), 'LineWidth', 1, 'Color', [colorsRGB(index4, :), 0.1]);
    % PSD parameters
    plot((solutionPSD{i}.X(:,1) + mean(problem{i}.data.auxData.HF.RRHSetup))*1000, solutionPSD{i}.U(:,1), '.', 'MarkerSize', 5, 'Color', colors(index4+1))
    ...
    hold on
    % ca vs RRH
    plot((solution{i}.X(:,1) + mean(problem{i}.data.auxData.HF.RRHSetup))*1000, solution{i}.U(:,2), '.', 'MarkerSize', 5,  'Color', colors(index4))
    plot((solution{i}.X(:,1) + mean(problem{i}.data.auxData.HF.RRHSetup))*1000, solution{i}.U(:,2), 'LineWidth', 1, 'Color', [colorsRGB(index4, :), 0.1]);
    
    % PSD parameters
    plot((solutionPSD{i}.X(:,1) + mean(problem{i}.data.auxData.HF.RRHSetup))*1000, solutionPSD{i}.U(:,2), '.', 'MarkerSize', 5,  'Color', colors(index4+1))
    ...
    hold on
    % ka vs RRH_Dot
    plot(solution{i}.X(:,2), solution{i}.U(:,1), '.', 'MarkerSize', 5, 'Color', colors(index4))
    plot(solution{i}.X(:,2), solution{i}.U(:,1), 'LineWidth', 1, 'Color', [colorsRGB(index4, :), 0.1]);
    
    % PSD parameters
    plot(solutionPSD{i}.X(:,2), solutionPSD{i}.U(:,1), '.', 'MarkerSize', 5, 'Color', colors(index4+1))
    ...
    hold on
    % ca vs RRH_Dot
    pScatter(index4leg) = plot(solution{i}.X(:,2), solution{i}.U(:,2), '.', 'MarkerSize', 5, 'Color', colors(index4));
    ...
    pScatter(index4leg) = plot(solutionPSD{i}.X(:,2), solutionPSD{i}.U(:,2), '.', 'MarkerSize', 5, 'Color', colors(index4));
...
%     
    ...
    % z_s dot
    plot(Axf42, problem{i}.data.auxData.HF.intervalTime, (problem{i}.data.auxData.HF.RRHDotInterval + problem{i}.data.auxData.HF.roadVecInterval)*1000, 'LineWidth', 2, 'LineStyle', '-', 'Color', 'k')
    % z_u - z_s
    ...
    figure
    hold on
    plot(solution{i}.T, solution{i}.U(:,3), 'LineWidth', 2, 'LineStyle', linestyle(index3), 'Color', colors(1))
    plot(solutionPSD{i}.T, solutionConst{i}.U(:,1), 'LineWidth', 2, 'LineStyle', linestyle(1), 'Color', colors(2))
    plot(solutionConst{i}.T, solutionPSD{i}.U(:,3), 'LineWidth', 2, 'LineStyle', linestyle(1), 'Color', colors(3))
    plot(problem{i}.data.auxData.HF.intervalTime, problem{i}.data.auxData.HF.FzRearInterval, 'LineWidth', 2, 'LineStyle', linestyle(1), 'Color', colors(4))
    xlabel('Time, s')
    ylabel('Fz, N')
    ...
    [track.x2_psd, track.y2_psd] = fnPSD(problem{i}.data.auxData.HF.intervalTime, problem{i}.data.auxData.HF.RRHDotInterval + problem{i}.data.auxData.HF.roadVecInterval, 'HighPassFreq', 2, 'HighPassOrder', 3);
    ...
    % Plots
    plot(Axf61, model_free.x1_psd, model_free.y1_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6))
    plot(Axf62, model_free.x2_psd, model_free.y2_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6))
    plot(Axf63, model_free.x3_psd, model_free.y3_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6))
    plot(Axf64, model_free.x4_psd, model_free.y4_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6))

    plot(Axf61, model_const.x1_psd, model_const.y1_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+1))
    plot(Axf62, model_const.x2_psd, model_const.y2_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+1))
    plot(Axf63, model_const.x3_psd, model_const.y3_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+1))
    plot(Axf64, model_const.x4_psd, model_const.y4_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+1))

    plot(Axf61, model_psd.x1_psd, model_psd.y1_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+2))
    plot(Axf62, model_psd.x2_psd, model_psd.y2_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+2))
    plot(Axf63, model_psd.x3_psd, model_psd.y3_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+2))
    plot(Axf64, model_psd.x4_psd, model_psd.y4_psd, 'LineWidth', 2, 'LineStyle', linestyle(index6), 'Color', colors(index6+2))
