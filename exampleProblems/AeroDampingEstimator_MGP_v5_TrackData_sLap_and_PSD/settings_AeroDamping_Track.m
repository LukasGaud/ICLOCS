function options = settings_AeroDamping_Track(varargin)
...
options.adigatorPath='C:\Users\lgaudiesius\GitHub\adigator';
...
%---------------------------------------
options.ipopt.tol=5e-5;                        % Desired convergence tolerance (relative). The default value is  1e-8. 
...
% options.tau=0;
% options.tau = auxData.HF.dT./sum(auxData.HF.dT);
options.tau = 0;
