...
if u(1) < auxData.P.kt-0.5*auxData.P.kt
    u(1) = auxData.P.kt-0.5*auxData.P.kt;
elseif u(1) > auxData.P.kt+2*auxData.P.kt
    u(1) = auxData.P.kt+2*auxData.P.kt;
end

if u(2) < 0
    u(2) = 0;
elseif u(2) > 2*auxData.P.ct
    u(2) = 2*auxData.P.ct;
end
