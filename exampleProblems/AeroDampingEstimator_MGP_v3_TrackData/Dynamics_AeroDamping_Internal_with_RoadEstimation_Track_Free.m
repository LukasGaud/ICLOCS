function [dx] = Dynamics_AeroDamping_Internal_with_RoadEstimation_Track_Free(x,u,p,t,vdat)
...
% Getting ks and cs
ks = interp1(vdat.auxData.P.xBumpVec, vdat.auxData.P.ksVec, x1-x3, 'linear', 'extrap');
cs = interp1(vdat.auxData.P.vDamVec, vdat.auxData.P.csVec, x2-x4, 'linear', 'extrap');
