...
% for i = 1:size(problem,2)
    ...
    % Model PSD
    % z_s-z_r
    plot(Axf41, solutionPSD{i}.T, (solutionPSD{i}.X(:,1)+ mean(problemConst{i}.data.auxData.HF.RRHSetup))*1000, 'LineWidth', 2, 'LineWidth', 2, 'LineStyle', linestyle(index5), 'Color', colors(index5))
    % z_s dot
