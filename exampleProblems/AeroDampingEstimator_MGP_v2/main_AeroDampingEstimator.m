...
% EoS Condition
[problemEoS,guessEoS]=AeroDampingEstimator(0);          % Fetch the problem definition
...
% LS Condition
[problemLS,guessLS]=AeroDampingEstimator(1);          % Fetch the problem definition
...
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.HF.RRHInterval-problemEoS.data.auxData.HF.zRHeaveInterval, '--r')

plot(solutionLS.T, solutionLS.X(:,1), 'k')
plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.HF.RRHInterval-problemLS.data.auxData.HF.zRHeaveInterval, '--g')
...
subplot(4,2, 6)
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.LF.FzRearInterval, 'b')

plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.LF.FzRearInterval, 'k')
title('Fz Rear')

subplot(4,2, 8)
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.HF.zRHeaveDotInterval, 'b')

plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.HF.zRHeaveDotInterval, 'k')
...
subplot(2,2,3)
hold on
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.LF.RRHInterval, 'b', 'LineWidth', 2)
plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.LF.RRHInterval, 'k', 'LineWidth', 2)
xlabel('Time, s')
title('RRH')

subplot(2,2,2)
hold on
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.LF.FzRearInterval, 'b', 'LineWidth', 2)
plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.LF.FzRearInterval, 'k', 'LineWidth', 2)
legend({'EoS', 'LS'})
xlabel('Time, s')
title('Fz Rear')
...
subplot(2,2,4)
hold on
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.HF.zRHeaveInterval, 'b', 'LineWidth', 2)
plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.HF.zRHeaveInterval, 'k', 'LineWidth', 2)
...
plot(problemEoS.data.auxData.HF.intervalTime, problemEoS.data.auxData.HF.RRHInterval-problemEoS.data.auxData.HF.zRHeaveInterval, '--r', 'LineWidth', 2)
legend({'Model - EoS', 'Track (V7P) - EoS'})
...
plot(problemLS.data.auxData.HF.intervalTime, problemLS.data.auxData.HF.RRHInterval-problemLS.data.auxData.HF.zRHeaveInterval, '--g', 'LineWidth', 2)
...
subplot(2,2,1)
hold on
plot((solutionEoS.X(:,1) + problemEoS.data.auxData.HF.zRHeaveInterval' + problemEoS.data.auxData.LF.RRHInterval')*1000, solutionEoS.U(:,2), '.b', 'LineWidth', 2);

plot((solutionLS.X(:,1) + problemLS.data.auxData.HF.zRHeaveInterval' + problemLS.data.auxData.LF.RRHInterval')*1000, solutionLS.U(:,2), '.k', 'LineWidth', 2);
...
plot((solutionEoS.X(:,1) + problemEoS.data.auxData.HF.zRHeaveInterval' + problemEoS.data.auxData.LF.RRHInterval')*1000, solutionEoS.U(:,1), '.b', 'LineWidth', 2);
plot((solutionLS.X(:,1) + problemLS.data.auxData.HF.zRHeaveInterval' + problemLS.data.auxData.LF.RRHInterval')*1000, solutionLS.U(:,1), '.k', 'LineWidth', 2);
...
ksDefEoS = problemEoS.data.auxData.LF.kHeaveInterval;
...
ksDefLS = problemLS.data.auxData.LF.kHeaveInterval;
